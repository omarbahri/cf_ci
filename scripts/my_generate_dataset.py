...
if __name__ == "__main__":
    ...
    output_dir = os.path.join(args.datadir, suffix)
    ...
    np.save(os.path.join(output_dir, "vel_train.npy"), vel_train)
    np.save(os.path.join(output_dir, "edges_train.npy"), edges_train)

    np.save(os.path.join(output_dir, "loc_valid.npy"), loc_valid)
    np.save(os.path.join(output_dir, "vel_valid.npy"), vel_valid)
    np.save(os.path.join(output_dir, "edges_valid.npy"), edges_valid)

    np.save(os.path.join(output_dir, "loc_test.npy"), loc_test)
    np.save(os.path.join(output_dir, "vel_test.npy"), vel_test)
    np.save(os.path.join(output_dir, "edges_test.npy"), edges_test)

    if args.temperature_dist:
        np.save(
            os.path.join(output_dir, "temperatures_train.npy"),
            temperature_samples_train,
        )
        np.save(
            os.path.join(output_dir, "temperatures_valid.npy"),
            temperature_samples_valid,
        )
        np.save(
            os.path.join(output_dir, "temperatures_test.npy"),
